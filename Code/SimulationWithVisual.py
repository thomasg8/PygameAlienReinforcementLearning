...
n_iterations= 1 # number of iterations in the simulation
delay=0 # adds delay between turns
...
def GameLoop(policy):
    ...
    while running: # while not dead
        ...
        # test for collision
        full_state=alien.state+boulder_state
        ...
        time.sleep(delay)
        turn+=1#; print(score, turn)

    return score, full_state
